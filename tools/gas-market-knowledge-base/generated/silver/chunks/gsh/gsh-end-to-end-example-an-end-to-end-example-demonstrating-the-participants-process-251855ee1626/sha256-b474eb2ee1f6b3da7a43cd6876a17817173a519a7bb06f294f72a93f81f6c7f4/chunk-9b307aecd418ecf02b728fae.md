---
{
  "chunk_id": "chunk-9b307aecd418ecf02b728fae",
  "chunk_ordinal": 191,
  "chunk_text_sha256": "0cfcfd624d87b2376e1292b5167b7fb566b812ad8db1167f73ff90844eecaee6",
  "chunking_settings": {
  ...
  "generated_path": "generated/silver/chunks/gsh/gsh-end-to-end-example-an-end-to-end-example-demonstrating-the-participants-process-251855ee1626/sha256-b474eb2ee1f6b3da7a43cd6876a17817173a519a7bb06f294f72a93f81f6c7f4/chunk-9b307aecd418ecf02b728fae.md",
  "heading_path": [
    "End to End Example"
  ],
  "path": "generated/silver/chunks/gsh/gsh-end-to-end-example-an-end-to-end-example-demonstrating-the-participants-process-251855ee1626/sha256-b474eb2ee1f6b3da7a43cd6876a17817173a519a7bb06f294f72a93f81f6c7f4/chunk-9b307aecd418ecf02b728fae.md",
  "schema_version": 1,
  "source_document_markdown_path": "generated/silver/documents/gsh/gsh-end-to-end-example-an-end-to-end-example-demonstrating-the-participants-process-251855ee1626/sha256-b474eb2ee1f6b3da7a43cd6876a17817173a519a7bb06f294f72a93f81f6c7f4.md"
}
---
...
d* < d < pd, Buyer Margin Rule (B(d)).Buyer Margin Rule (B(d)) = 0. d* < d < pd, Seller Margin Rule (S(d)).Member not subject to Trading Halt* = 0.20. d* < d < pd, Seller Margin Rule (S(d)).Member subject to Trading Halt* = 1.25. pd ≤ d ≤ pd + 1, Buyer Margin Rule (B(d)).Buyer Margin Rule (B(d)) = 1. pd ≤ d ≤ pd + 1, Seller Margin Rule (S(d)).Member not subject to Trading Halt* = 0.80. pd ≤ d ≤ pd + 1, Seller Margin Rule (S(d)).Member subject to Trading Halt* = -0.25. d > pd + 1, Buyer Margin Rule (B(d)).Buyer Margin Rule (B(d)) = 1. d > pd + 1, Seller Margin Rule (S(d)).Member not subject to Trading Halt* = -0.25. d > pd + 1, Seller Margin Rule (S(d)).Member
