"""Shared silver document Markdown extraction from cached source PDFs."""
    ...
    *,
    ...
    return (
        SourceDocumentEntry(
            ...
            content_sha256=checked_content_sha256,
            pdf_path=source_pdf_cache_path(
                checked_content_sha256,
                cache_dir=cache_dir,
            ),
...
def _frontmatter_payload(
    ...
    *,
    ...
    return {
        ...
        "content_sha256": entry.content_sha256,
        "generated_path": display_path(entry.output_path),
