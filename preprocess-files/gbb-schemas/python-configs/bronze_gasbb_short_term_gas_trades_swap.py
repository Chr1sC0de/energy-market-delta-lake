...
#     ╭────────────────────────────────────────────────────────────────────────────────────────╮
#     │                define table and register for Short Term Gas Swap Trades report         │
#     ╰────────────────────────────────────────────────────────────────────────────────────────╯

key_prefix = ["bronze", "aemo", "gasbb"]

table_name = "bronze_gasbb_short_term_gas_trades_swap"

s3_prefix = "aemo/gasbb"

s3_file_glob = "gasbbshorttermgastradesswap*"
...
schema_descriptions = {
    ...
    "TransactionType": "Whether the swap is a location swap, time swap or both location and time swap.",
...
GASBB_SHORT_TERM_GAS_TRADES_SWAP_* reports are updated monthly.

Contains all short term gas swap transactions, excluding those concluded through the gas trading exchange.
"""
