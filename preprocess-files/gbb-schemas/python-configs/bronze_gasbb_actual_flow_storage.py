...
#     ╭────────────────────────────────────────────────────────────────────────────────────────╮
#     │                define table and register for Actual Flow And Storage report            │
#     ╰────────────────────────────────────────────────────────────────────────────────────────╯
...
GASBB_ACTUAL_FLOW_STORAGE is updated daily / GASBB_ACTUAL_FLOW_STORAGE_LAST_31 is updated within 30 minutes of receiving new data.

GASBB_ACTUAL_FLOW_STORAGE report shows historic records back to Sep 2018. GASBB_ACTUAL_FLOW_STORAGE_LAST_31 shows records from the last 31 days.
"""
