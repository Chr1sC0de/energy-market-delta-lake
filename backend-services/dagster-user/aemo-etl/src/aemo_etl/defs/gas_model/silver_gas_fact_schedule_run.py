...
SOURCE_TABLES = ["silver.vicgas.silver_int108_v4_scheduled_run_log_7_1"]
...
COLUMN_LINEAGE = TableColumnLineage(
    deps_by_column={
        ...
        "transmission_document_id": [
            TableColumnDep(asset_key=INT108_KEY, column_name="transmission_document_id")
        ],
...
def _select_schedule_runs(int108: LazyFrame) -> LazyFrame:
    return (
        int108.with_columns(
            ...
            objective_function_value=pl.col("objective_function_value").cast(
                pl.Float64
            ),
...
@asset(
    ...
    ins={"int108": AssetIn(key=INT108_KEY)},
