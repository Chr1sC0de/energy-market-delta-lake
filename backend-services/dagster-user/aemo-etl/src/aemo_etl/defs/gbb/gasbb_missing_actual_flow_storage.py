...
defs = df_from_s3_keys_definitions_factory(
    domain="gbb",
    name_suffix="gasbb_missing_actual_flow_storage",
    glob_pattern="gasbbmissingactualflowandstorage*",
    schema={
        "GasDate": String,
        "FacilityName": String,
        "FacilityId": Int64,
    ...
    description="Missing actual flow data. Updated daily, covers the last 31 days.",
)
