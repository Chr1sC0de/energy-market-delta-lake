...
defs = df_from_s3_keys_definitions_factory(
    domain="gbb",
    name_suffix="gasbb_late_actual_flow_storage",
    glob_pattern="gasbblateactualflowandstorage*",
    schema={
        "GasDate": String,
        "FacilityName": String,
        "FacilityId": Int64,
    ...
    schema_descriptions={
        ...
        "LateTimeSpan": "Hours and minutes between submission cut-off time and earliest submission date.",
