...
defs = df_from_s3_keys_definitions_factory(
    domain="gbb",
    name_suffix="gasbb_pipeline_connection_flow_history",
    glob_pattern="pipelineconnectionflow_history*",
    schema={
        "GasDate": String,
        "FacilityName": String,
        "FacilityId": Int64,
    ...
    description=(
        "Daily production and usage at each Connection Point. "
        "Historical data from Sep 2018."
    ),
)
