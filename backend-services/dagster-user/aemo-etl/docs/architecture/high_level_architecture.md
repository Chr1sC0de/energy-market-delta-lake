...
The STTM source-table bronze coverage spans complete v19.1 spec-backed public
reports: `INT651` through `INT684` and `INT687` through `INT691`. Typed
bronze targets run from `bronze/sttm/bronze_int651_v1_ex_ante_market_price_rpt_1`
