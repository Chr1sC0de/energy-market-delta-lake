...
live-discovery source family for landing public major-publications, GSOO, and
WA GSOO publication bytes under `bronze/aemo_major_publications`; its
...
count. Validate that source family with
