    ...
    mo.vstack(
        [
            ...
            **Dashboard brief**: **Dashboard intent**: Analytical. Analysts,
            data engineers, and operators use this dashboard to audit the
            Marimo-local citation chain from dashboard concept metadata to
            generated-gold paths, source chunk IDs, silver chunk paths, and
            source hashes. Data scope is the code-local dashboard registry only;
            generated gold Markdown and generated silver chunk files remain
            read-only citation anchors and are not opened at runtime. Freshness
            is the registry snapshot packaged with the deployed dashboard image.
            The dashboard reads no table rows; missing paths, chunk IDs, or
            source hashes render as registry coverage gaps.
            """),
