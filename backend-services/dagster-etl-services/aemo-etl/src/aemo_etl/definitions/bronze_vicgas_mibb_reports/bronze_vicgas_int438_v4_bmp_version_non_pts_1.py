...
table_name = "bronze_vicgas_int438_v4_bmp_version_non_pts_1"
...
table_schema = {
    ...
    "version_id": Int64,
    "extract_type": String,
    "version_from_date": Datetime(time_unit="ms", time_zone="UTC"),
    "version_to_date": Datetime(time_unit="ms", time_zone="UTC"),
    "issued_date": Datetime(time_unit="ms", time_zone="UTC"),
