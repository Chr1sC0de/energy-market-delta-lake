...
table_name = "bronze_vicgas_int152_v4_sched_min_qty_linepack_1"
...
table_schema = {
    ...
    "commencement_datetime": Datetime(time_unit="ms", time_zone="UTC"),
    "ti": Int64,
    "termination_datetime": Datetime(time_unit="ms", time_zone="UTC"),
    "unit_id": String,
