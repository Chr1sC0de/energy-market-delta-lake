...
class S3NemwebLinkProcessor(NEMWebLinkProcessor):
    ...
    def process(
        ...
        s3_client.upload_fileobj(
            ...
            f"{self.s3_target_prefix}/{upload_filename}",
        )

        target_s3_href = (
            f"s3://{self.s3_target_bucket}/{self.s3_target_prefix}/{upload_filename}"
        )
        ...
        processed_link = ProcessedLink(
            ...
            target_s3_bucket=self.s3_target_bucket,
            target_s3_prefix=self.s3_target_prefix,
