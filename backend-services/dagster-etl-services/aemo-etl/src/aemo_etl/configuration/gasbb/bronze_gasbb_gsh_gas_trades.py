...
def CONFIG() -> ReportConfig:
    ...
    return gasbb_config_factory(
        ...
        report_purpose="""
            The file below provides a complete list of historical trades. This data can
            be used to analyse market trends over time. If you are after a more simple
            and straightforward representation of price trends in the GSH, the benchmark
            price report (outlined below) may be more appropriate.
        """,
    )
