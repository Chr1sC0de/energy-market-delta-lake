...
def CONFIG() -> ReportConfig:
    ...
    return gasbb_config_factory(
        ...
        report_purpose="""
            A list shippers who have contracted primary Storage, Compression or Pipeline
            capacity.

            This report is updated daily.

            GASBB_SHIPPERS_LIST contains current records / GASBB_SHIPPERS_FULL_LIST
            includes historic records.
        """,
    )
