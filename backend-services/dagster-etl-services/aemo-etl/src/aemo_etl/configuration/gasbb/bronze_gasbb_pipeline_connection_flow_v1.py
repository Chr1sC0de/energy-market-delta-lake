"""bronze_gasbb_pipeline_connection_flow_v1 - Bronze GASBB report configuration."""
...
def CONFIG() -> ReportConfig:
    ...
    return gasbb_config_factory(
        table_name="bronze_gasbb_pipeline_connection_flow_v1",
        s3_file_glob="gasbb_pipeline_connection_flow*",
        primary_keys=["GasDate", "FacilityId", "ConnectionPointId", "FlowDirection"],
        table_schema={
            "GasDate": String,
            "FacilityName": String,
            "FacilityId": Int64,
        ...
        schema_descriptions={
            ...
            "FlowDirection": """
                A conditional value of either: RECEIPT — A flow of gas into the BB
                pipeline, or DELIVERY — A flow of gas out of the BB pipeline.
            """,
            "ActualQuantity": """
                The actual flow quantity reported in TJ to the nearest terajoule with
            ...
            "Quality": """
                ...
                Values can be either: OK, NIL, OOR, Not Available.
            """,
            "surrogate_key": """
        ...
        report_purpose="""
            Provides a report for the Daily production and usage at each Connection
            Point.

            GASBB_PIPELINE_CONNECTION_FLOW is updated daily.
            GASBB_PIPELINE_CONNECTION_FLOW_LAST_31 is typically updated within 30
            minutes of receiving new data.
