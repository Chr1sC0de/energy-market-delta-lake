...
def CONFIG() -> ReportConfig:
    ...
    return gasbb_config_factory(
        ...
        schema_descriptions={
            ...
            "ReceiptLocationId": """
                The Connection Point Id that best represents the receipt location
                associated with a pipeline's nameplate capacity flow direction.
            """,
            "ReceiptLocationName": """
                The Connection Point name associated with the ReceiptLocationId.
            """,
            "DeliveryLocationId": """
                The Connection Point Id that best represents the delivery location
                associated with a pipeline's nameplate capacity flow direction.
            """,
            "DeliveryLocationName": """
                The Connection Point name associated with the DeliveryLocationId.
            """,
            "Description": """
                Describes the calculation that is being performed in each row of the
                report.
            """,
            "ForecastMethod": """
                Describes the calculation that is being performed for each BB pipeline
                where the Description is Forecast Flow.
            """,
            ...
            "Nameplate": """
                Standing nameplate capacity quantity in TJ. Nameplate rating relates to
                maximum daily quantities under normal operating conditions.
            """,
            "surrogate_key": """
        ...
        report_purpose="""
            ...
            forecast information provided by Gas Bulletin Board (BB) facility
            operators. The report is a 7-day outlook of the supply-demand gas
            balance in the East Coast.
