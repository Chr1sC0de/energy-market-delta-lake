...
def CONFIG() -> ReportConfig:
    ...
    return gasbb_config_factory(
        ...
        schema_descriptions={
            ...
            "EarliestSubmissionDate": """
                Date and time of the earliest submission for that gas date.
            """,
            "LateTimeSpan": """
                Hours and minutes of the time span between the submission cut-off time
                and the earliest submission date.
            """,
            "surrogate_key": """
        ...
        report_purpose="""
            A record of late submissions for BB reporting entities for each BB facility
            type.
