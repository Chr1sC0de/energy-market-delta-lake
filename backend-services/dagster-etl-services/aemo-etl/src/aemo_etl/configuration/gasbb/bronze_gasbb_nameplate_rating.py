    ...
    return gasbb_config_factory(
        ...
        schema_descriptions={
            ...
            "capacitytype": """
                ...
                MDQ: Daily maximum firm capacity (name plate) under the expected
            ...
            "flowdirection": """
                ...
                DeliveryLngStor, or NONE.
            """,
            "capacitydescription": """
                Free text to describe the meaning of the capacity number provided,
                including relevant assumptions made in the calculation of the capacity
            ...
            """,
            "description": """
                Free text facility use is restricted to a description for reasons or
                comments directly related to the quantity or the change in quantity
                provided in relation to a BB facility.
            """,
        ...
        report_purpose="""
            This report displays the standing nameplate capacity of all BB facilities
            and BB compression facility. Nameplate rating relates to maximum daily
            quantities in TJ under normal operating conditions.

            GASBB_NAMEPLATE_RATING_FULL_LIST is updated annually /
            GASBB_NAMEPLATE_RATING_CURRENT is updated within 30 minutes of receiving new
            data.

            GASBB_NAMEPLATE_RATING_FULL_LIST contains historical records /
