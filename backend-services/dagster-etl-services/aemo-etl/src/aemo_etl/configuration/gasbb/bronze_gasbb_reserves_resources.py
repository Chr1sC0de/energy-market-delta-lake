...
def CONFIG() -> ReportConfig:
    ...
    return gasbb_config_factory(
        ...
        schema_descriptions={
            ...
            "DevelopedReserve1P": """
                An estimate of the BB field interest's 1P developed reserves.
            """,
            "DevelopedReserve2P": """
                An estimate of the BB field interest's 2P developed reserves.
            """,
            "DevelopedReserve3P": """
                An estimate of the BB field interest's 3P developed reserves.
            """,
            "UndevelopedReserve1P": """
                An estimate of the BB field interest's 1P undeveloped reserves.
            """,
            "UndevelopedReserve2P": """
                An estimate of the BB field interest's 2P undeveloped reserves.
            """,
            "UndevelopedReserve3P": """
                An estimate of the BB field interest's 3P undeveloped reserves.
            """,
            "Resources2C": "An estimate of the BB field interest's 2C resources.",
            "ProductionChangeReserve2P": """
                An estimate of the total movement in the BB field interest's 2P reserves
                since the end of prior reporting year due to the production of gas.
            """,
            "ProvedAreaExtensionReserve2P": """
                An estimate of the total movement in the BB field interest's 2P reserves
                since the end of prior reporting year due to the extension of a field's
                proved area.
            """,
            "PercentageChangeReserve2P": """
                An estimate of the total movement in the BB field interest's 2P reserves
                since the end of prior reporting year due to a percentage change in the
                BB field interest.
            """,
            "UpwardRevisionFrom3PReserveTo2P": """
                An estimate of the total movement in the BB field interest's 2P reserves
                since the end of prior reporting year due to an upward revision of 2P
                reserves arising from the reclassification of 3P reserves or resources
                to 2P reserves.
            """,
            "DownwardRevisionFrom2PReserveTo3P": """
                An estimate of the total movement in the BB field interest's 2P reserves
                since the end of prior reporting year due to a downward revision of 2P
                reserves arising from the reclassification of 2P reserves to 3P reserves
                or resources.
            """,
            "OtherRevisionsReserve2P": """
                An estimate of the total movement in the BB field interest's 2P reserves
                since the end of prior reporting year due to other revisions.
            """,
            ...
            "ResourcesEstimateMethod": """
                The resources assessment method used to prepare the reserves and
                resources estimates.
            """,
            "ConversionFactorQtyTCFtoPJ": """
                The conversion factor used to convert quantities measured in trillions
                of cubic feet to PJ.
            """,
            "EconomicAssumption": """
                The key economic assumptions in the forecast case used to prepare the
                reserves and resources estimates and the source of the assumptions.
            """,
            "UpdateReason": "The reason for the update.",
            "PreparedBy": "The name of the person who prepared the estimates.",
            "PreparationIndependenceStatement": """
                Whether the qualified gas industry professional who prepared, or
                supervised the preparation of, the reserves and resources estimates is
