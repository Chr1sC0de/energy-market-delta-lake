...
def CONFIG() -> ReportConfig:
    ...
    return mibb_config_factory(
        ...
        schema_descriptions={
            ...
            "current_date": """
                Date and Time the report is produced e.g. 21 Jun 2001 16:42:35
            """,
            "surrogate_key": """
        ...
        report_purpose="""
            ...
            This public report is produced each time a change occurs. It identifies
            nodes that the MCE uses. The nodal prices from MCE forms the network prices.

            Each report contains the: - pipeline identifier - point group identifier and
            name - nodal altitude - last modified date - date and time when the report
            was produced
        """,
