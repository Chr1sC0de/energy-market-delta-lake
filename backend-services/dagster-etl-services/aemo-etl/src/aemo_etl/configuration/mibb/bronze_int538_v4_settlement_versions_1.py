...
def CONFIG() -> ReportConfig:
    ...
    return mibb_config_factory(
        ...
        report_purpose="""
            ...
            statement is issued. Participants may wish to use this report as a reference
            to link other reports together based on invoice id(balancing version).

            A report is produced when balancing statement is issued. This report is
            similar to VIC MIBB report INT438.

            Each report contains the: - statement version identifier - settlement
            category type - effective start date - effective end date - date of issue -
