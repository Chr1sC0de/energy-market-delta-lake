...
def CONFIG() -> ReportConfig:
    ...
    return mibb_config_factory(
        ...
        schema_descriptions={
            ...
            "effective_from": """
                Date when the HV zone became effective for the mirn, Example: 01 Aug
                2023
            """,
            "current_date": """
                Date and time report produced, Example: 30 Jun 2007 06:00:00)
            """,
            "surrogate_key": """
        ...
        report_purpose="""
            ...
            The report provides the mapping of active DTS CTMs to the Heating Value
            Zones. The mapping of non-DTS CTM to heating value zone mapping for South
