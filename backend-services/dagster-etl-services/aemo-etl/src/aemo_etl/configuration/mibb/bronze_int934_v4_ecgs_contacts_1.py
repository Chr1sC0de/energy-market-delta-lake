...
def CONFIG() -> ReportConfig:
    ...
    return mibb_config_factory(
        ...
        report_purpose="""
            ...
            AEMO only publishes a portion of the Part 27 Register information required
            by section 6.1 of the ECGS Procedures.

            This report is a comma separated values (CSV) file that contains each Part
            27 relevant entity's active ECGS Responsible Person contacts. The ECGS
            Responsible Person contact receives ECGS notices from AEMO. This report is
            published to the: 1. Market Information Bulletin Board (MIBB) public folder
