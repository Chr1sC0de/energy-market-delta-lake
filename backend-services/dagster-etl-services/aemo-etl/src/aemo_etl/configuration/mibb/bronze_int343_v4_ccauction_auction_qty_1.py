...
def CONFIG() -> ReportConfig:
    ...
    return mibb_config_factory(
        ...
        report_purpose="""
            This report provides the CC capacities available for auction by zone and
            period after the announcement that the CC auction is open.

            A report is produced when CC auction is triggered. This report will show the
            auctionable quantity for each product for a particular auction ID in csv
            format. Sort order is by Zone and Capacity Period in ascending order.
        """,
