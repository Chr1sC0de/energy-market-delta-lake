...
def CONFIG() -> ReportConfig:
    ...
    return mibb_config_factory(
        ...
        schema_descriptions={
            ...
            "gas_date": "Gas Day date the temperature data applies to (e.g. 30 Jun 2007)",  # noqa: E501
            "last_update_datetime": "Time data obtained and loaded into AEMO's database (e.g. 05:00:00)",  # noqa: E501
            "previous_day_min": "Previous day over night minimum temperature (NULL from 15 April 2024)",  # noqa: E501
            ...
            "average_wind_speed": "Average wind speed (knots) (NULL from 15 April 2024)",  # noqa: E501
            "sunshine": "Hours of sunshine (NULL from 15 April 2024)",
            "effective_temperature": "Effective temperature calculated by AEMO's Demand Forecasting System (DFS)",  # noqa: E501
            "dfs_edd": "Effective Degree Day (EDD) calculated by AEMO's Demand Forecasting System (DFS)",  # noqa: E501
            "total_demand_forecast": "AEMO's total daily demand forecast for the gas day calculated by AEMO's Demand Forecasting System (DFS)",  # noqa: E501
