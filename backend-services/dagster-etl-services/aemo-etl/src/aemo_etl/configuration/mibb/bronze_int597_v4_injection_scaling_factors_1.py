...
def CONFIG() -> ReportConfig:
    ...
    return mibb_config_factory(
        ...
        report_purpose="""
            This report is produced for the settlement period and shows the scaling
            factor adjustments for aggregated injections in Distribution region and
            withdrawal zone.

            This public report shows the daily scaling factors used in adjusting the
            retailer injections to match the actual withdrawals in a distribution region
            and withdrawal zone. There is no equivalent VIC MIBB report.

            Each report contents the: - network name - statement version identifier -
            gas date - distributor name - withdrawal zone - scaling factor - current
            date
        """,
