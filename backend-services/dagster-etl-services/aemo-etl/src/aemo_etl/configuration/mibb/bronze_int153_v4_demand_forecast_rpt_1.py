...
def CONFIG() -> ReportConfig:
    ...
    return mibb_config_factory(
        ...
        schema_descriptions={
            ...
            "version_id": "Forecast version used to identify which forecast was used in the schedule (reference INT108)",  # noqa: E501
            "ti": "Time interval (1-24)",
            "forecast_demand_gj": "Forecast total hourly demand (in GJ/hour) potentially used as input in the MCE",  # noqa: E501
            "vc_override_gj": "Quantity (in GJ) of any AEMO override (can be either positive or negative)",  # noqa: E501
