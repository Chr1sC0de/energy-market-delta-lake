    ...
    return mibb_config_factory(
        ...
        schema_descriptions={
            ...
            "super_compressability_factor": """
                Super Compressability Factor e.g. 859999999999999999
            """,
            ...
            "current_date": """
                Date and Time the report is produced e.g. 21 Jun 2001 16:34:57
            """,
            "surrogate_key": """
        ...
        report_purpose="""
            This report lists what the standard parameters are that are used as input
            data for Market Clearing Engine (MCE) in generating schedules for the
            market.

            This public report shows the current MCE factors and is produced when a
            change occurs to the factors.
