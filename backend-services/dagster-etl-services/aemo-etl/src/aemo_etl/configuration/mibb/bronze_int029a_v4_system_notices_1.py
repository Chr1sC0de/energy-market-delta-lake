...
def CONFIG() -> ReportConfig:
    ...
    return mibb_config_factory(
        ...
        schema_descriptions={
            ...
            "url_path": "Path to any attachment included in the notice e.g. Public/Master_MIBB_report_list.zip",  # noqa: E501
            "current_date": "Date and time the report was produced e.g. Jul 23 2007 16:30:35",  # noqa: E501
