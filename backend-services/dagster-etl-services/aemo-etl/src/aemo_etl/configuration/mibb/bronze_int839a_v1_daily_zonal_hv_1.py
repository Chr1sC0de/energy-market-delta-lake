...
def CONFIG() -> ReportConfig:
    ...
    return mibb_config_factory(
        ...
        report_purpose="""
            ...
            AEMO processes files sent by distributors and publishes the heating values
            via this public MIBB report. This process is only applicable to Network
            NSWCR and COUNTRY.

            The 'Published Daily Zonal heating value for the day' is a CSV report
            listing all of the Heating Value zones where the distributor is the current
            distributor.
