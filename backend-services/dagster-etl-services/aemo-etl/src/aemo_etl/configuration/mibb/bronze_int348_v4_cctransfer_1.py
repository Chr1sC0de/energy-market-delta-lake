...
def CONFIG() -> ReportConfig:
    ...
    return mibb_config_factory(
        ...
        report_purpose="""
            This report provides the approved CC transfer amounts conducted on the
            previous day.

            This report will be published on the following gas day (D+1) if a transfer
            of capacity certificates has been approved on the previous gas day. The
            report will be published at midnight. If no transfer of capacity
            certificates has been approved, the report will not be published. The report
            provides information about the amount of CC transferred for a CC zone and CC
            product period.
        """,
