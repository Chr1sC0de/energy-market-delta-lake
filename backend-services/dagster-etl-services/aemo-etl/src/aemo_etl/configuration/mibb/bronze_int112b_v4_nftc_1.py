...
def CONFIG() -> ReportConfig:
    ...
    return mibb_config_factory(
        ...
        schema_descriptions={
            ...
            "commencement_date": "e.g. 27 Jun 2011. Dates that mark the boundary of the application of the constraint",  # noqa: E501
            "termination_date": "e.g. 27 Jun 2011. Dates that mark the boundary of the application of the constraint",  # noqa: E501
