...
def CONFIG() -> ReportConfig:
    ...
    return mibb_config_factory(
        ...
        This report is a comma separated values (CSV) file that contains ECGS
        notices published by AEMO to the public and is sent to Part 27 Relevant
        Entities via email and SMS.
        ...
        The dual publication of this report allows existing Victorian DWGM and
        Gas Retail  Market participants to access it via the MIBB. The general
        public and electricity market participants can access this report
        directly via NEMWeb.

        The "url path" field in the report reflects the MIBB folder location.

        Documents that are uploaded to the MIBB folder is replicated to the Any
        PDF following locations:

        1. MIBB/Public/ECGS_attachments
        2. www.nemweb.com.au - /REPORTS/CURRENT/ECGS/ECGS_Notices/Attachments/

        Each report contains the details of all the general ECGS notices that
        are in effect for Relevant Entities at the report generation time.
