...
def CONFIG() -> ReportConfig:
    ...
    return mibb_config_factory(
        ...
        report_purpose="""
            This is a public report generated for actual volumes of gas that contribute
            to APs (volumes of out of merit order gas). Report to be on the issue of
            each settlement (M+7, M+18 and M+118).
        """,
