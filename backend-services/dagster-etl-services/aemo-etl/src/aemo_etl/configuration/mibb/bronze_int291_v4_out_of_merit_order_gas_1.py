...
def CONFIG() -> ReportConfig:
    ...
    return mibb_config_factory(
        ...
        schema_descriptions={
            ...
            "ancillary_amt_gst_ex": "Total estimated AP for the gas day (net position as at the last schedule of the day) ancillary_amt_gst_ex = SUM(payment_amt) FROM ap_daily_sched_mirn per gas_date for inj_wdl_flag = 'I'",  # noqa: E501
            "scheduled_out_of_merit_gj": "Net out of merit order GJs scheduled and delivered over the day scheduled_out_of merit_gj = SUM(ap_qty_gj) FROM ap_constrained_up per gas_date for inj_wdl_flag = 'I'",  # noqa: E501
