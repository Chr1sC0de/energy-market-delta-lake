"""bronze_int322a_v4_uplift_breakdown_sett_1 - Bronze MIBB report configuration."""
...
def CONFIG() -> ReportConfig:
    ...
    return mibb_config_factory(
        table_name="bronze_int322a_v4_uplift_breakdown_sett_1",
        s3_file_glob="int322a_v4_uplift_breakdown_sett_1*",
        primary_keys=["gas_date", "sched_no"],
        table_schema={
