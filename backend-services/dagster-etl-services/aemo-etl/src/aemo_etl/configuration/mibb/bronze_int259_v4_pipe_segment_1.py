...
def CONFIG() -> ReportConfig:
    ...
    return mibb_config_factory(
        ...
        schema_descriptions={
            ...
            "node_origin_id": """
                Last of the location node at the beginning of the segment e.g. 3
            """,
            "diameter": "Last of diameter of pipe segment e.g. 74139999999999995",
            "diameter_paired": """
                Last of diameter of a parallel pipeline e.g. 741399999999995
            """,
            ...
            "max_pressure_delta": """
                Last of max pressure differentials along a segment e.g. 1350.0
            """,
            ...
            "compressor": """
                Yes denotes that the pipe segment has a compressor station on it e.g. N
            """,
        ...
        report_purpose="""
            ...
            This public report is produced each time a change occurs. The report is
            similar to INT258 and shows minimum and maximum volumes for pipelines and
            the pressure of gas.

            Each report contains the: - pipe segment id and name - linepack zone id -
            commencement and termination dates - node destination and origin id - pipe
            segment measurements - details of pressure - if a regulator, reverse flow
            and compressor exists - last modified date
