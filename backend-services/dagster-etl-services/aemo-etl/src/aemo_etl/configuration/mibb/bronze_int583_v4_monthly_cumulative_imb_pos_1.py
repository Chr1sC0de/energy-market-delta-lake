...
def CONFIG() -> ReportConfig:
    ...
    return mibb_config_factory(
        ...
        report_purpose="""
            This report shows the cumulative imbalance position of Retailers. Retailers
            may wish to use this report to track their status of the imbalance to do the
            necessary adjustments.

            This public report is updated at each issue of settlement to show the status
            of each retailer's imbalance position. There is no equivalent VIC MIBB
            report.

            Each report contains the: - network name - statement version id -
            financially Responsible Organisation - distributor Name - withdrawal zone -
            current cumulative imbalance issue date - current cumulative imbalance
            position (Surplus, Deficit or Balanced) - date and time report produced
        """,
