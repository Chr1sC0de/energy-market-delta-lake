...
def CONFIG() -> ReportConfig:
    ...
    return mibb_config_factory(
        ...
        schema_descriptions={
            "demand_type_name": "Normal Uses Demand forecast used by operational schedule",  # noqa: E501
            ...
            "current_date": "Date and time the report is produced e.g. 29 Jun 2007 01:23:45",  # noqa: E501
