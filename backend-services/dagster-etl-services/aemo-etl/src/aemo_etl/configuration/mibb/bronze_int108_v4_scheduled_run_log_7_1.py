...
def CONFIG() -> ReportConfig:
    ...
    return mibb_config_factory(
        ...
        schema_descriptions={
            ...
            "transmission_group_id": "To link the Operational Schedule to the Market Schedule of an ante schedule",  # noqa: E501
            "gas_start_datetime": "Similar to Schedule_Start_date but not absolute (Trading between midnight and 6:00 AM is considered to be belonged to the previous day)",  # noqa: E501
            "bid_cutoff_datetime": "If the submission datetime is after the datetime specified by this Bid_Cutoff_Date then the nomination (or bids) is used",  # noqa: E501
            ...
            "last_os_for_gas_day_tdoc_id": "Last Operating schedule for the day either a 1 PM or an ad hoc",  # noqa: E501
            "os_prior_gas_day_tdoc_id": "Last Operating schedule for the previous day either a 1 PM or an ad hoc",  # noqa: E501
            "approval_datetime": "Date and time of approval",
            "demand_type_id": "Type of demand: '0' = Normal, '1' = Plus 10 percent, '2' = Minus 10 percent",  # noqa: E501
            "objective_function_value": "Objective_Function_Value for each run. This value is returned from the MCE",  # noqa: E501
