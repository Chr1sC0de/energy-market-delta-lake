...
table_name = "silver_int037b_indicative_mkt_price"
s3_prefix = "aemo/mibb"
...
@dagster_asset(
    ...
    ins={
        "bronze_int037b_v4_indicative_mkt_price_1": AssetIn(
...
def table_asset(
    bronze_int037b_v4_indicative_mkt_price_1: LazyFrame,
) -> LazyFrame:
    return bronze_int037b_v4_indicative_mkt_price_1.with_columns(
        col("gas_date")
