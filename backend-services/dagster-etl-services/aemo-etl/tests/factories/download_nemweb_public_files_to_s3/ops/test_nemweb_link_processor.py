...
class TestS3NemwebLinkProcessor:
    def test_process_uploads_to_s3(
        ...
        result = processor.process(build_op_context(), mock_s3_resource, mock_link)
    ...
    def test_process_lowercases_filename(
        ...
        result = processor.process(build_op_context(), mock_s3_resource, link_uppercase)
    ...
    def test_process_extracts_filename_from_url(
        ...
        result = processor.process(
            build_op_context(), mock_s3_resource, link_nested_path
        )
    ...
    def test_process_with_none_upload_datetime(
        ...
        result = processor.process(
            build_op_context(), mock_s3_resource, link_no_datetime
        )
